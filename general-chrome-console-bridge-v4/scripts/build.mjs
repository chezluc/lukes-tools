...
const extensionName = process.env.BRIDGE_EXTENSION_NAME ?? `General Chrome Console Bridge (${bridgeBrowserLabel})`;
const extensionDescription = process.env.BRIDGE_EXTENSION_DESCRIPTION
  ?? `Bridge-tab Chrome console bridge for ${bridgeBrowserLabel} on ${bridgeBaseUrl}.`;
